...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään Desk Viewer verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa Desk Viewer ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi Desk Viewerin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava Desk Viewerille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava Desk Viewerille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten Desk Viewer daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota Desk Viewerille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli Desk Viewer ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "Desk Viewer palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa Desk Viewerin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "Desk Viewer palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep Desk Viewer background service", "Pidä Desk Viewerin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista Desk Viewerin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show Desk Viewer", "Näytä Desk Viewer"),
        ...
        ("verify_deskviewer_password_tip", "Vahvista Desk Viewer salasanasi kirjautumista varten"),
        ...
        ("{} sessions", "{} istuntoa"),
        ("safety_title", "Huijausvaroitus"),
        ("safety_text1", "Älä anna tuntemattomille henkilöille pääsyä tietokoneeseesi."),
        ("safety_text2", "Desk Viewer ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Päivitä Desk Viewer Server Pro versioon {} jatkaaksesi."),
        ...
        ("About Desk Viewer", "Tietoa Desk Vieweristä"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Päivitä etä-Desk Viewer-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena Desk Viewer vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, Desk Viewer ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, Desk Viewer ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: Desk Viewer-palvelimen OSS ei sisällä tätä ominaisuutta."),

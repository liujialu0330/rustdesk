...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Desk Viewer sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, Desk Viewer ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian Desk Viewer sistema mailan instalatzeko."),
        ("Click to upgrade", "Egin klik bertsio-berritzeko"),
        ("Configure", "Konfiguratu"),
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, Desk Viewer-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, Desk Viewer-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, Desk Viewer \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [Desk Viewer Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep Desk Viewer background service", "Mantendu Desk Viewer atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez Desk Viewer aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show Desk Viewer", "Erakutsi Desk Viewer"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ("Elevate", "Igo maila"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, Desk Viewer-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, Desk Vieweri-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den Desk Viewer UAC leihoan"),
        ...
        ("verify_deskviewer_password_tip", "Berretsi Desk Viewer pasahitza"),
        ...
        ("{} sessions", "{} saio"),
        ("safety_title", "IRUZURTUA izan zintezke!"),
        ("safety_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta Desk Viewer erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ("safety_text2", "Ziurrenik zure dirua edo informazio pribatua lapurtzen saiatzen ari diren iruzurgileak dira."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Mesedez, bertsio-berritu Desk Viewer Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek Desk Viewer kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "Desk Viewer-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa Desk Viewer leihoa irekita badago"),
        ...
        ("floating_window_tip", "Desk Viewer atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("About Desk Viewer", "Desk Viewer-i buruz"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Mesedez, eguneratu Desk Viewer bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, Desk Viewer-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, Desk Viewer-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, Desk Viewer-ek ez du gehiago UDP 21116 erabiliko; horren ordez, TCP 21116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: Desk Viewer zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),

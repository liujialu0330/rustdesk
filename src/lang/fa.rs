...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای Desk Viewer برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز Desk Viewer برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز Desk Viewer برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "این نسخه viewer-only سرویس اشتراک ورودی دستگاه محلی را ارائه نمی‌کند."),
        ("android_input_permission_tip2", "برای این نسخه نیازی به فعال کردن سرویس ورودی سیستم نیست."),
        ("android_new_connection_tip", "درخواست جدیدی برای مدیریت دستگاه فعلی شما دریافت شده است."),
        ("android_service_will_start_tip", "سرویس اشتراک دستگاه محلی در این نسخه غیرفعال است."),
        ...
        ("android_start_service_tip", "سرویس اشتراک صفحه محلی در این نسخه غیرفعال است."),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep Desk Viewer background service", "را در پس زمینه نگه دارید Desk Viewer سرویس"),
        ...
        ("Show Desk Viewer", "Desk Viewer نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "تعامل صفحه‌کلید از تنظیمات نشست متصل استفاده می‌کند."),
        ("config_microphone", "ارسال صدا در این نسخه غیرفعال است."),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای Desk Viewer کلیک کند."),
        ...
        ("verify_deskviewer_password_tip", "رمز عبور Desk Viewer را تأیید کنید"),
        ...
        ("{} sessions", "{} جلسه"),
        ("safety_title", "ممکن است شما در حال کلاهبرداری باشید!"),
        ("safety_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید Desk Viewer اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ("safety_text2", "آنها احتمالا یک کلاهبردار هستند که سعی در سرقت پول یا سایر اطلاعات خصوصی شما دارند."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید Desk Viewer Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند Desk Viewer روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود Desk Viewer زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند Desk Viewer این به حفظ سرویس پس زمینه"),
        ...
        ("About Desk Viewer", "Desk Viewer درباره"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "لطفاً Desk Viewer را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، Desk Viewer گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، Desk Viewer دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، Desk Viewer دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور Desk Viewer OSS این ویژگی را ندارد."),

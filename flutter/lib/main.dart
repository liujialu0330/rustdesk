...
import 'package:deskviewer/common/widgets/overlay.dart';
import 'package:deskviewer/desktop/pages/desktop_tab_page.dart';
import 'package:deskviewer/desktop/pages/install_page.dart';
import 'package:deskviewer/desktop/pages/server_page.dart';
import 'package:deskviewer/desktop/screen/desktop_file_transfer_screen.dart';
import 'package:deskviewer/desktop/screen/desktop_view_camera_screen.dart';
import 'package:deskviewer/desktop/screen/desktop_port_forward_screen.dart';
import 'package:deskviewer/desktop/screen/desktop_remote_screen.dart';
import 'package:deskviewer/desktop/screen/desktop_terminal_screen.dart';
...
import 'common.dart';
import 'consts.dart';
import 'mobile/android_channel.dart';
import 'mobile/pages/home_page.dart';
import 'mobile/widgets/deploy_dialog.dart';
import 'models/platform_model.dart';

import 'package:deskviewer/plugin/handlers.dart'
    if (dart.library.html) 'package:deskviewer/web/plugin/handlers.dart';
...
void runMainApp(bool startService) async {
  ...
  if (startService && !(isAndroid && kAndroidViewerOnly)) {
  ...
  windowManager.waitUntilReadyToShow(windowOptions, () async {
    ...
    if (handledByUniLinks || handleUriLink(cmdArgs: kBootArgs)) {
      ...
      deskViewerWinManager.registerActiveWindow(kWindowMainId);
    }

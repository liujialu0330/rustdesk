...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het Desk Viewer netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer Desk Viewer op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u Desk Viewer toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u Desk Viewer toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u Desk Viewer toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [Desk Viewer Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep Desk Viewer background service", "Desk Viewer achtergronddienst behouden"),
        ...
        ("Show Desk Viewer", "Toon Desk Viewer"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u Desk Viewer toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u Desk Viewer toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Bevestiging wachtwoord Desk Viewer"),
        ...
        ("{} sessions", "{} sessies"),
        ("safety_title", "U wordt misschien opgelicht!"),
        ("safety_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om Desk Viewer te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ("safety_text2", "Het is waarschijnlijk een oplichter die probeert uw geld of andere privégegevens te stelen."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Upgrade Desk Viewer Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor Desk Viewer mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het Desk Viewer-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt Desk Viewer op de achtergrond actief te houden"),
        ...
        ("About Desk Viewer", "Over Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Upgrade de Desk Viewer client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert Desk Viewer het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat Desk Viewer verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt Desk Viewer niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de Desk Viewer-server."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til Desk Viewer-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan Desk Viewer ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Desk Viewer på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give Desk Viewer \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give Desk Viewer \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give Desk Viewer mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [Desk Viewer Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep Desk Viewer background service", "Behold Desk Viewer baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn Desk Viewer appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show Desk Viewer", "Vis Desk Viewer"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af Desk Viewer er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give Desk Viewer rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give Desk Viewer rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Bekræft Desk Viewer adgangskode"),
        ...
        ("{} sessions", "{} sessioner"),
        ("safety_title", "ADVARSEL: Du kan blive SVINDLET!"),
        ("safety_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge Desk Viewer til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ("safety_text2", "Det er højest sandsynligvis en svinder som forsøger at stjæle dine penge eller andre personlige oplysninger."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Opgradér venligst Desk Viewer Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre Desk Viewer i at køre normalt."),
        ...
        ("powered_by_me", "Drives af Desk Viewer"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af Desk Viewer med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis Desk Viewer vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at Desk Viewer baggrundstjenesten kører"),
        ...
        ("About Desk Viewer", "Om Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Opgrader venligst Desk Viewer-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer Desk Viewer servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil Desk Viewer springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil Desk Viewer ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: Desk Viewer server OSS indeholder ikke denne funktion."),

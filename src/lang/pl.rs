...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Desk Viewer może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować Desk Viewer w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić Desk Viewer przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić Desk Viewer na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [Desk Viewer Input]."),
        ...
        ("Language", "Język"),
        ("Keep Desk Viewer background service", "Zachowaj usługę Desk Viewer w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji Desk Viewer, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show Desk Viewer", "Pokaż Desk Viewer"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji Desk Viewer uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać Desk Viewer uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z Desk Viewer w Twojej sieci."),
        ...
        ("verify_deskviewer_password_tip", "Weryfikuj hasło Desk Viewer"),
        ...
        ("{} sessions", "{} sesji"),
        ("safety_title", "Możesz być ofiarą OSZUSTWA!"),
        ("safety_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu Desk Viewer - nie rób tego i natychmiast się rozłącz."),
        ("safety_text2", "Jest to prawdopodobnie oszust, który próbuje ukraść Twoje pieniądze lub inne prywatne informacje."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Proszę zaktualizować Desk Viewer Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu Desk Viewer po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno Desk Viewer jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę Desk Viewer w tle"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Proszę zaktualizować zdalny klient Desk Viewer do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie Desk Viewer weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, Desk Viewer pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, Desk Viewer nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS Desk Viewer nie obsługuje tej funkcji."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Desk Viewer..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), Desk Viewer potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Desk Viewer a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a Desk Viewer il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a Desk Viewer il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a Desk Viewer di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [Desk Viewer Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep Desk Viewer background service", "Mantieni il servizio di Desk Viewer in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione Desk Viewer, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show Desk Viewer", "Visualizza Desk Viewer"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a Desk Viewer 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a Desk Viewer."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Conferma password Desk Viewer"),
        ...
        ("Exit", "Esci da Desk Viewer"),
        ("Open", "Apri Desk Viewer"),
        ...
        ("{} sessions", "{} sessioni"),
        ("safety_title", "Potresti essere stato TRUFFATO!"),
        ("safety_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare Desk Viewer e di avviare il servizio, non procedere e riattacca subito."),
        ("safety_text2", "Probabilmente è un truffatore che cerca di rubare i tuoi soldi o altre informazioni private."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Aggiorna Desk Viewer Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di Desk Viewer come lato controllato."),
        ...
        ("Swap control-command key", "Inverti tasto controllo-comando"),
        ("swap-left-right-mouse", "Inverti pulsante sinistro-destro mouse"),
        ("2FA code", "Codice 2FA"),
        ("More", "Altro"),
        ...
        ("powered_by_me", "Alimentato da Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra Desk Viewer è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Desk Viewer in background."),
        ...
        ("About Desk Viewer", "Info su Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Aggiorna il client Desk Viewer remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, Desk Viewer verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, Desk Viewer salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, Desk Viewer non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server Desk Viewer non include questa funzionalità."),

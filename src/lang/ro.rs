...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Desk Viewer..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Desk Viewer să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Desk Viewer."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Desk Viewer acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Desk Viewer acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Desk Viewer să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Desk Viewer Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep Desk Viewer background service", "Rulează serviciul Desk Viewer în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Desk Viewer, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show Desk Viewer", "Afișează Desk Viewer"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Desk Viewer permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Desk Viewer permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Desk Viewer care rulează."),
        ...
        ("verify_deskviewer_password_tip", "Verifică parola Desk Viewer"),
        ...
        ("{} sessions", "{} sesiuni"),
        ("safety_title", "Avertisment de securitate"),
        ("safety_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi Desk Viewer pentru a-ți accesa dispozitivul."),
        ("safety_text2", "Dacă nu ai contactat tu primul asistența tehnică, te rugăm să închizi această aplicație imediat."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Versiunea serverului Desk Viewer Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul Desk Viewer pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu Desk Viewer"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web Desk Viewer Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări Desk Viewer. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About Desk Viewer", "Despre Desk Viewer"),
        ...
        ("web_id_input_tip", "Introdu ID-ul Desk Viewer al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Versiunea clientului Desk Viewer de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește Desk Viewer Pro pentru funcționalitate completă."),

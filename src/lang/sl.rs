...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Desk Viewer..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Desk Viewer v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Desk Vieweru dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Desk Vieweru dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Desk Vieweru dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Desk Viewer Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Desk Viewer background service", "Ohrani Desk Viewerovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Desk Viewer, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Desk Viewer potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "Desk Viewer potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_deskviewer_password_tip", "Preveri geslo za Desk Viewer"),
        ...
        ("{} sessions", "{} sej"),
        ("safety_title", "Lahko gre za prevaro!"),
        ("safety_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Desk Viewer, prekinite klic in program zaprite."),
        ("safety_text2", "Desk Viewer omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Prosimo, nadgradite Desk Viewer Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Desk Viewera odprto"),
        ...
        ("floating_window_tip", "Pomaga pri Desk Viewer storitvi v ozadju"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Prosimo, nadgradite Desk Viewer odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto Desk Viewer preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo Desk Viewer ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, Desk Viewer ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik Desk Viewer OSS ne vključuje te funkcije."),

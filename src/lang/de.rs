...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem Desk Viewer-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann Desk Viewer in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren Desk Viewer auf dem System."),
        ("Click to upgrade", "Zum Upgraden klicken"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie Desk Viewer Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie Desk Viewer die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie Desk Viewer erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"Desk Viewer Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep Desk Viewer background service", "Desk Viewer im Hintergrund ausführen"),
        ...
        ("Show Desk Viewer", "Desk Viewer anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie Desk Viewer die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie Desk Viewer die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von Desk Viewer auf \"Ja\" klicken."),
        ...
        ("verify_deskviewer_password_tip", "Desk Viewer-Passwort bestätigen"),
        ...
        ("{} sessions", "{} Sitzungen"),
        ("safety_title", "Sie werden möglicherweise BETROGEN!"),
        ("safety_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, Desk Viewer zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ("safety_text2", "Es handelt sich wahrscheinlich um einen Betrüger, der versucht, Ihr Geld oder andere private Informationen zu stehlen."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Bitte aktualisieren Sie Desk Viewer Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass Desk Viewer als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von Desk Viewer"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von Desk Viewer.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von Desk Viewer mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das Desk Viewer-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, Desk Viewer im Hintergrund auszuführen."),
        ...
        ("About Desk Viewer", "Über Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Bitte aktualisieren Sie den Desk Viewer-Client auf der Remote-Seite auf Version {} oder neuer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standardmäßig überprüft Desk Viewer das Serverzertifikat für Protokolle, die TLS verwenden. Wenn diese Option aktiviert ist, überspringt Desk Viewer den Überprüfungsschritt und fährt im Falle eines Überprüfungsfehlers fort."),
        ("Disable UDP", "UDP deaktivieren"),
        ("disable-udp-tip", "Legt fest, ob nur TCP verwendet werden soll. Wenn diese Option aktiviert ist, verwendet Desk Viewer nicht mehr UDP 21116, sondern stattdessen TCP 21116."),
        ("server-oss-not-support-tip", "HINWEIS: Desk Viewer Server OSS enthält diese Funktion nicht."),

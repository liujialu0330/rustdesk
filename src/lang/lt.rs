...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie Desk Viewer tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti Desk Viewer netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte Desk Viewer į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti Desk Viewer \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti Desk Viewer leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad Desk Viewer startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti Desk Viewer naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"Desk Viewer įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep Desk Viewer background service", "Palikti Desk Viewer fonine paslauga"),
        ...
        ("Show Desk Viewer", "Rodyti Desk Viewer"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti Desk Viewer leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti Desk Viewer leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant Desk Viewer UAC lange paspaustų \"OK\"."),
        ...
        ("verify_deskviewer_password_tip", "Įveskite kliento Desk Viewer slaptažodį"),
        ...
        ("{} sessions", "{} seansai"),
        ("safety_title", "GALBŪT ESATE APGAUDINĖJAMI!"),
        ("safety_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti Desk Viewer bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ("safety_text2", "Tikėtina, kad tai sukčius, bandantis pavogti jūsų pinigus ar kitą asmeninę informaciją."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Prašome atnaujinti Desk Viewer Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti Desk Viewer tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas Desk Viewer langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti Desk Viewer foninę paslaugą"),
        ...
        ("About Desk Viewer", "Apie Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės Desk Viewer klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus Desk Viewer tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju Desk Viewer praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, Desk Viewer nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: Desk Viewer serverio OSS šios funkcijos neturi."),

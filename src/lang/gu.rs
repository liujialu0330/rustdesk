...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં Desk Viewer શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep Desk Viewer background service", "Desk Viewer બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("Show Desk Viewer", "Desk Viewer બતાવો"),
        ("This PC", "આ PC"),
        ("or", "અથવા"),
        ("Elevate", "એલિવેટ કરો"),
        ...
        ("verify_deskviewer_password_tip", "Desk Viewer પાસવર્ડ ચકાસો"),
        ...
        ("{} sessions", "{} સત્રો"),
        ("safety_title", "છેતરપિંડીની ચેતવણી!"),
        ("safety_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે Desk Viewer વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ("safety_text2", "આ એક છેતરપિંડી હોઈ શકે છે. કોઈને પાસવર્ડ આપશો નહીં."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "સર્વર પ્રો ને {} માં અપગ્રેડ કરો"),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર Desk Viewer વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે Desk Viewer બતાવો"),
        ...
        ("About Desk Viewer", "Desk Viewer વિશે"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "રિમોટ ક્લાયન્ટને {} માં અપગ્રેડ કરો"),

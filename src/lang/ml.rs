...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "സെറ്റിംഗ്സിൽ Desk Viewer കണ്ടെത്തി അത് ഓൺ ചെയ്യുക."),
        ...
        ("Language", "ഭാഷ"),
        ("Keep Desk Viewer background service", "Desk Viewer ബാക്ക്ഗ്രൗണ്ടിൽ പ്രവർത്തിപ്പിക്കുക"),
        ...
        ("Show Desk Viewer", "Desk Viewer കാണിക്കുക"),
        ("This PC", "ഈ പിസി"),
        ("or", "അല്ലെങ്കിൽ"),
        ...
        ("verify_deskviewer_password_tip", "Desk Viewer പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("{} sessions", "{} സെഷനുകൾ"),
        ("safety_title", "തട്ടിപ്പ് മുന്നറിയിപ്പ്!"),
        ("safety_text1", "നിങ്ങൾക്ക് പരിചയമില്ലാത്ത ആരെങ്കിലും Desk Viewer ഉപയോഗിക്കാൻ ആവശ്യപ്പെട്ടാൽ ഉടൻ കണക്ഷൻ വിച്ഛേദിക്കുക."),
        ("safety_text2", "ഇതൊരു തട്ടിപ്പായിരിക്കാം. ആർക്കും പാസ്‌വേഡ് നൽകരുത്."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "സെർവർ പ്രോ {} ലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക"),
        ...
        ("allow-only-conn-window-open-tip", "Desk Viewer വിൻഡോ തുറന്നിരിക്കുമ്പോൾ മാത്രം കണക്ഷൻ അനുവദിക്കുക"),
        ...
        ("floating_window_tip", "ബാക്ക്ഗ്രൗണ്ടിലാണെങ്കിലും Desk Viewer കാണിക്കുക"),
        ...
        ("About Desk Viewer", "Desk Viewer-നെ കുറിച്ച്"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "റിമോട്ട് പതിപ്പ് {} ലേക്ക് മാറ്റുക"),

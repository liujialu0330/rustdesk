...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में Desk Viewer खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep Desk Viewer background service", "Desk Viewer बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show Desk Viewer", "Desk Viewer दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_deskviewer_password_tip", "Desk Viewer पासवर्ड सत्यापित करें"),
        ...
        ("{} sessions", "{} सत्र"),
        ("safety_title", "धोखाधड़ी की चेतावनी!"),
        ("safety_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे Desk Viewer उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ("safety_text2", "यह एक घोटाला हो सकता है। अपना आईडी या पासवर्ड किसी को न दें।"),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Desk Viewer सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब Desk Viewer विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान Desk Viewer को दिखाएं"),
        ...
        ("About Desk Viewer", "Desk Viewer के बारे में"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "रिमोट Desk Viewer क्लाइंट को संस्करण {} में अपग्रेड करें"),

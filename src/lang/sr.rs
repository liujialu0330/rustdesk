...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC Desk Viewer ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Desk Viewer na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Ova viewer-only verzija ne zahteva lokalni servis za unos."),
        ("config_screen", "Ova viewer-only verzija ne zahteva lokalni servis za deljenje ekrana."),
        ...
        ("android_input_permission_tip1", "Ova Android viewer-only verzija ne pruža deljenje lokalnog unosa."),
        ("android_input_permission_tip2", "Nije potrebno uključivati sistemski servis za unos za ovu verziju."),
        ("android_new_connection_tip", "Dolazno deljenje lokalnog uređaja je onemogućeno u ovoj verziji."),
        ("android_service_will_start_tip", "Servis za deljenje lokalnog uređaja je onemogućen u ovoj verziji."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Desk Viewer aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show Desk Viewer", "Prikazi Desk Viewer"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite Desk Viewer-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite Desk Viewer-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog Desk Viewer-a."),
        ...
        ("verify_deskviewer_password_tip", "Potvrdi Desk Viewer lozinku"),
        ...
        ("{} sessions", "{} sesija"),
        ("safety_title", "Možda ste ŽRTVA PREVARE!"),
        ("safety_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite Desk Viewer i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ("safety_text2", "Verovatno su prevaranti koji pokušavaju da vam ukradu novac ili druge privatne informacije."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Molimo nadogradite Desk Viewer Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti Desk Viewer da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je Desk Viewer prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se Desk Viewer pozadinski servis održi"),
        ...
        ("About Desk Viewer", "O Desk Viewer-u"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Molimo nadogradite Desk Viewer klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, Desk Viewer proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, Desk Viewer će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, Desk Viewer više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: Desk Viewer server OSS ne uključuje ovu funkciju."),

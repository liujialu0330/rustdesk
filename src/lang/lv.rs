...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar Desk Viewer tīklu..."),
        ...
        ("install_tip", "UAC dēļ Desk Viewer dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu Desk Viewer sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir Desk Viewer \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir Desk Viewer \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj Desk Viewer izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [Desk Viewer Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep Desk Viewer background service", "Saglabāt Desk Viewer fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo Desk Viewer lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show Desk Viewer", "Rādīt Desk Viewer"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ("Elevate", "Pacelt"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir Desk Viewer \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir Desk Viewer \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Pārbaudīt Desk Viewer paroli"),
        ...
        ("{} sessions", "{} sesijas"),
        ("safety_title", "Tevi var APKRĀPT!"),
        ("safety_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot Desk Viewer, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ("safety_text2", "Viņi, visticamāk, ir krāpnieki, kas mēģina nozagt tavu naudu vai citu privātu informāciju."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Lūdzu, jauniniet Desk Viewer Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut Desk Viewer pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts Desk Viewer logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt Desk Viewer fona servisu"),
        ...
        ("About Desk Viewer", "Par Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Lūdzu, jauniniet attālās puses Desk Viewer klientu uz versiju {} vai jaunāku!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma Desk Viewer pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, Desk Viewer izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, Desk Viewer vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. Desk Viewer servera OSS neietver šo funkciju."),

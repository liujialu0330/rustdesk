...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Desk Viewer..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Desk Viewer fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Desk Viewer på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Desk Viewer \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Desk Viewer \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Desk Viewer Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Desk Viewer background service", "Behåll Desk Viewer i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Desk Viewer programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show Desk Viewer", "Visa Desk Viewer"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge Desk Viewer behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge Desk Viewer behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Verifiera Desk Viewer-lösenord"),
        ...
        ("{} sessions", "{} sessioner"),
        ("safety_title", "Du kan vara utsatt för BEDRÄGERI!"),
        ("safety_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda Desk Viewer och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ("safety_text2", "De är troligen bedragare som försöker stjäla dina pengar eller annan privat information."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Uppgradera Desk Viewer Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra Desk Viewer från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om Desk Viewer-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla Desk Viewer-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Uppgradera Desk Viewer-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar Desk Viewer serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar Desk Viewer över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder Desk Viewer inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: Desk Viewer server OSS inkluderar inte denna funktion."),

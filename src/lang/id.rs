...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke Desk Viewer..."),
        ...
        ("install_tip", "Karena UAC, Desk Viewer tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal Desk Viewer ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk Desk Viewer."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk Desk Viewer."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd Desk Viewer untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input Desk Viewer]."),
        ...
        ("Language", "Bahasa"),
        ("Keep Desk Viewer background service", "Pertahankan Desk Viewer berjalan pada service background"),
        ...
        ("Show Desk Viewer", "Tampilkan Desk Viewer"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada Desk Viewer"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada Desk Viewer"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC Desk Viewer yang sedang berjalan"),
        ...
        ("verify_deskviewer_password_tip", "Verifikasi Kata Sandi Desk Viewer"),
        ...
        ("{} sessions", "sesi {}"),
        ("safety_title", "Kemungkinan anda Sedang DITIPU!"),
        ("safety_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan Desk Viewer, jangan lanjutkan dan segera tutup panggilan."),
        ("safety_text2", "Kemungkinan besar mereka adalah komplotan penipu yang berusaha mencuri uang atau informasi pribadi anda."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Silahkan perbarui Desk Viewer Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah Desk Viewer berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela Desk Viewer sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service Desk Viewer agar tetap aktif"),
        ...
        ("About Desk Viewer", "Tentang Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Silahkan perbarui aplikasi Desk Viewer ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, Desk Viewer memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, Desk Viewer akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, Desk Viewer tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: Desk Viewer server OSS tidak menyertakan fitur ini."),

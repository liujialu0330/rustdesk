...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto Desk Viewer..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali Desk Viewer sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al Desk Viewer."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al Desk Viewer."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al Desk Viewer uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [Desk Viewer Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep Desk Viewer background service", "Tenu Desk Viewer fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de Desk Viewer, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show Desk Viewer", "Montri Desk Viewer"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al Desk Viewer permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al Desk Viewer permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Kontroli Desk Viewer-pasvorton"),
        ...
        ("{} sessions", "{} sesioj"),
        ("safety_title", "Vi Eble Estas TRUMPATA!"),
        ("safety_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi Desk Viewer kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ("safety_text2", "Ili verŝajne estas trompisto kiu provas ŝteli vian monon aŭ aliajn privatajn informojn."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Bonvolu ĝisdatigi Desk Viewer Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi Desk Viewer funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de Desk Viewer estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de Desk Viewer"),
        ...
        ("About Desk Viewer", "Pri Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Bonvolu ĝisdatigi la Desk Viewer-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, Desk Viewer kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, Desk Viewer retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, Desk Viewer ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: Desk Viewer-servilo OSS ne inkluzivas ĉi tiun funkcion."),

...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    if(NOT EXISTS "${LIBVPX_INCLUDE_DIR}")
        file(GLOB LIBVPX_INCLUDE_CANDIDATES "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/vpx-*-v${VERSION}/include/vpx")
        if(LIBVPX_INCLUDE_CANDIDATES)
            list(GET LIBVPX_INCLUDE_CANDIDATES 0 LIBVPX_INCLUDE_DIR)
        endif()
    endif()
    file(
        INSTALL

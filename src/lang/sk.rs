...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na Desk Viewer server..."),
        ...
        ("install_tip", "V niektorých prípadoch Desk Viewer nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii Desk Viewer udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii Desk Viewer udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii Desk Viewer udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [Desk Viewer Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Desk Viewer background service", "Ponechať službu Desk Viewer na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení Desk Vieweru, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show Desk Viewer", "Zobraziť Desk Viewer"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie Desk Viewer \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte Desk Vieweru udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Overenie hesla Desk Viewer"),
        ...
        ("{} sessions", "{} relácií"),
        ("safety_title", "Možno ste boli oklamaní!"),
        ("safety_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie Desk Viewer, nepokračujte v hovore a okamžite zaveste."),
        ("safety_text2", "Pravdepodobne ide o podvodníka, ktorý sa snaží ukradnúť vaše peniaze alebo iné súkromné informácie."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Aktualizujte Desk Viewer Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu Desk Vieweru ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie Desk Viewer"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu Desk Viewer na pozadí"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Aktualizujte klienta Desk Viewer na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne Desk Viewer overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou Desk Viewer v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, Desk Viewer už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: Desk Viewer server OSS túto funkciu neobsahuje."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Desk Viewer mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a Desk Viewer ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate Desk Viewer na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, Desk Viewer-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Desk Viewer-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti Desk Viewer-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [Desk Viewer Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep Desk Viewer background service", "Zadrži Desk Viewer kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje Desk Viewer aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show Desk Viewer", "Prikaži Desk Viewer"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti Desk Vieweru dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti Desk Vieweru \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog Desk Viewera."),
        ...
        ("verify_deskviewer_password_tip", "Provjera lozinke za Desk Viewer"),
        ...
        ("{} sessions", "{} sesija"),
        ("safety_title", "Možda vas je netko PREVARIO!"),
        ("safety_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete Desk Viewer, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ("safety_text2", "Ovo je vjerojatno prevarant koji pokušava ukrasti vaš novac ili druge privatne podatke."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Ažurirajte Desk Viewer Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti Desk Viewer da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor Desk Viewera otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa Desk Viewera"),
        ...
        ("About Desk Viewer", "O Desk Vieweru"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Molimo ažurirajte Desk Viewer klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, Desk Viewer provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, Desk Viewer će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, Desk Viewer više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: Desk Viewer poslužitelj OSS ne uključuje ovu značajku."),

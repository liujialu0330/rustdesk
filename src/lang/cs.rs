...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k Desk Viewer síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), Desk Viewer v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak Desk Viewer do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci Desk Viewer udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci Desk Viewer udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby Desk Viewer mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [Desk Viewer vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Desk Viewer background service", "Zachovat službu Desk Viewer na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace Desk Viewer, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show Desk Viewer", "Zobrazit Desk Viewer"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění Desk Viewer \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění Desk Viewer \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného Desk Vieweru."),
        ...
        ("verify_deskviewer_password_tip", "Ověření hesla Desk Viewer"),
        ...
        ("{} sessions", "{} sezení"),
        ("safety_title", "Možná vás někdo PODVEDL!"),
        ("safety_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby Desk Viewer a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ("safety_text2", "Pravděpodobně se jedná o podvodníka, který se snaží ukrást vaše peníze nebo jiné soukromé informace."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Aktualizujte prosím Desk Viewer Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu Desk Vieweru jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno Desk Viewer"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu Desk Viewer na pozadí"),
        ...
        ("About Desk Viewer", "O Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Upgradujte prosím klienta Desk Viewer na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení Desk Viewer ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, Desk Viewer v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, Desk Viewer již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: Desk Viewer server OSS tuto funkci neobsahuje."),

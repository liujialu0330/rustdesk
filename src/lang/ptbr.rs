...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do Desk Viewer..."),
        ...
        ("install_tip", "Devido ao UAC, o Desk Viewer não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Desk Viewer no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao Desk Viewer permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao Desk Viewer permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o Desk Viewer use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [Desk Viewer Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Desk Viewer background service", "Manter o serviço do Desk Viewer executando em segundo plano"),
        ...
        ("Show Desk Viewer", "Exibir Desk Viewer"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do Desk Viewer."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do Desk Viewer."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Verifique a senha do Desk Viewer"),
        ...
        ("{} sessions", "{} sessões"),
        ("safety_title", "Você pode estar sendo ENGANADO!"),
        ("safety_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o Desk Viewer e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ("safety_text2", "Provavelmente são golpistas tentando roubar seu dinheiro ou informações privadas."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Atualize o Desk Viewer Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o Desk Viewer funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do Desk Viewer estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço Desk Viewer em segundo plano"),
        ...
        ("About Desk Viewer", "Sobre Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Atualize o cliente Desk Viewer para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o Desk Viewer verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o Desk Viewer ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o Desk Viewer não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor Desk Viewer OSS não inclui este recurso."),

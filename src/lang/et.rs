...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Desk Vieweri võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Desk Viewer mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Desk Viewer oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb Desk Viewerile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb Desk Viewerile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma Desk Viewerile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Desk Viewer Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep Desk Viewer background service", "Säilita Desk Vieweri taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele Desk Vieweri rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show Desk Viewer", "Kuva Desk Viewer"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma Desk Viewerile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma Desk Viewerile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud Desk Vieweri kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_deskviewer_password_tip", "Kinnita Desk Vieweri parool"),
        ...
        ("{} sessions", "{} seanssi"),
        ("safety_title", "Võid olla KELMUSE ohver!"),
        ("safety_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul Desk Vieweri kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ("safety_text2", "Tõenäoliselt on tegemist petturiga, kes üritab sinu raha või muid privaatseid andmeid varastada."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Palun täienda Desk Viewer Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib Desk Vieweril takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb Desk Vieweril"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui Desk Vieweri aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada Desk Vieweri taustateenust."),
        ...
        ("About Desk Viewer", "Desk Vieweri teave"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Täiendage Desk Vieweri klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib Desk Viewer TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab Desk Viewer kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta Desk Viewer enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: Desk Vieweri serveri OSS ei sisalda seda funktsiooni."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, Desk Viewer bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, Desk Viewer'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için Desk Viewer'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için Desk Viewer'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, Desk Viewer'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [Desk Viewer Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep Desk Viewer background service", "Desk Viewer arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki Desk Viewer uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show Desk Viewer", "Desk Viewer'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için Desk Viewer'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için Desk Viewer'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan Desk Viewer'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_deskviewer_password_tip", "Desk Viewer parolasını doğrulayın"),
        ...
        ("{} sessions", "{} oturum"),
        ("safety_title", "Dolandırılıyor Olabilirsiniz!"),
        ("safety_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden Desk Viewer'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ("safety_text2", "Muhtemelen paranızı veya diğer özel bilgilerinizi çalmaya çalışan dolandırıcılardır."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Lütfen Desk Viewer Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, Desk Viewer'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "Desk Viewer tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca Desk Viewer penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "Desk Viewer arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About Desk Viewer", "Desk Viewer Hakkında"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Lütfen uzak tarafta Desk Viewer istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, Desk Viewer sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda Desk Viewer doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, Desk Viewer artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: Desk Viewer sunucu OSS'si bu özelliği içermemektedir."),

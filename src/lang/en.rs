...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Desk Viewer network..."),
        ...
        ("Remote Computer", "Connected computer"),
        ...
        ("install_tip", "This viewer-only build connects to your own server and does not provide local device sharing service."),
        ("config_acc", "No local-device input service is required for this viewer-only build."),
        ("config_screen", "No local-device screen sharing service is required for this viewer-only build."),
        ...
        ("Enter Remote ID", "Enter device ID"),
        ...
        ("Screen Capture", "Image stream"),
        ("Input Control", "Input channel"),
        ("Audio Capture", "Audio channel"),
        ("Open System Setting", "Open system setting"),
        ("android_input_permission_tip1", "This viewer-only Android build does not provide local-device input sharing."),
        ("android_input_permission_tip2", "No system input service needs to be enabled for this build."),
        ("android_new_connection_tip", "Incoming local-device sharing is disabled in this build."),
        ("android_service_will_start_tip", "Local-device sharing service is disabled in this build."),
        ("android_stop_service_tip", "Closing the service will automatically close all established connections."),
        ("android_version_audio_tip", "Local audio capture is disabled in this build."),
        ("android_start_service_tip", "Local screen sharing service is disabled in this build."),
        ...
        ("doc_mac_permission", "https://deskviewer.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Desk Viewer application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "Keyboard interaction uses the connected desktop session settings."),
        ("config_microphone", "Audio speaking is disabled in this build."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Verify Desk Viewer password"),
        ...
        ("safety_title", "Untrusted request warning"),
        ("safety_text1", "Only use Desk Viewer with your own devices or people you personally trust. Do not share IDs, passwords, or server keys with unknown callers."),
        ("safety_text2", "If this connection was not initiated by you, close the app and review your server settings."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Please upgrade Desk Viewer Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://deskviewer.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Desk Viewer from running properly as controlled side."),
        ...
        ("preset_password_warning", "This customized edition comes with a preset password. Anyone knowing this password could connect to your device. If you did not expect this, uninstall the software immediately."),
        ("share_warning_tip", "The fields above are shared and visible to others."),
        ("ab_web_console_tip", "More on web console"),
        ("allow-only-conn-window-open-tip", "Only allow connection if Desk Viewer window is open"),
        ...
        ("floating_window_tip", "It helps to keep Desk Viewer background service"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Please upgrade the Desk Viewer client to version {} or newer on the remote side!"),
        ("view_camera_unsupported_tip", "The remote device does not support viewing the camera."),
        ("d3d_render_tip", "When D3D rendering is enabled, the connected screen may be black on some machines."),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Desk Viewer verifies the server certificate for protocols using TLS.\nWith this option enabled, Desk Viewer will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Desk Viewer will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Desk Viewer server OSS doesn't include this feature."),

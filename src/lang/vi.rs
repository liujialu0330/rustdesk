...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Desk Viewer..."),
        ...
        ("install_tip", "Do cơ chế UAC, Desk Viewer có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Desk Viewer vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Desk Viewer."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Desk Viewer."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Desk Viewer Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Desk Viewer background service", "Giữ dịch vụ Desk Viewer chạy nền"),
        ...
        ("Show Desk Viewer", "Hiện Desk Viewer"),
        ...
        ("verify_deskviewer_password_tip", "Xác thực mật khẩu Desk Viewer"),
        ...
        ("{} sessions", "{} phiên"),
        ("safety_title", "CẢNH BÁO LỪA ĐẢO"),
        ("safety_text1", "KHÔNG chia sẻ ID/Mật khẩu với người lạ qua điện thoại. Nếu họ yêu cầu, họ có thể là kẻ lừa đảo."),
        ("safety_text2", "Chỉ sử dụng Desk Viewer với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Desk Viewer mở"),
        ...
        ("floating_window_tip", "Giữ Desk Viewer trên cùng"),
        ...
        ("About Desk Viewer", "Về Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),

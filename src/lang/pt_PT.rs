...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Desk Viewer..."),
        ...
        ("install_tip", "Devido ao UAC, o Desk Viewer não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Desk Viewer no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Desk Viewer permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Desk Viewer permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Desk Viewer use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Desk Viewer Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Desk Viewer background service", "Manter o serviço Desk Viewer em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação Desk Viewer, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show Desk Viewer", "Mostrar Desk Viewer"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Desk Viewer as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Desk Viewer as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Desk Viewer em execução."),
        ...
        ("verify_deskviewer_password_tip", "Verificar palavra-passe do Desk Viewer"),
        ...
        ("{} sessions", "{} sessões"),
        ("safety_title", "PODE ESTAR A SER VÍTIMA DE BURLA!"),
        ("safety_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Desk Viewer e iniciar o serviço, não prossiga e desligue imediatamente."),
        ("safety_text2", "É provável que seja um burlão a tentar roubar o seu dinheiro ou outras informações privadas."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Atualize o Desk Viewer Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Desk Viewer de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Desk Viewer estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Desk Viewer"),
        ...
        ("About Desk Viewer", "Sobre o Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Atualize o cliente Desk Viewer para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o Desk Viewer verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o Desk Viewer recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o Desk Viewer deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o Desk Viewer server OSS não inclui esta funcionalidade."),

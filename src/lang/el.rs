...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο Desk Viewer..."),
        ...
        ("install_tip", "Λόγω UAC, το Desk Viewer ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το Desk Viewer στο σύστημα"),
        ("Click to upgrade", "Κάντε κλίκ για αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για να ελέγξετε την επιφάνεια εργασίας σας από απόσταση, πρέπει να παραχωρήσετε στο Desk Viewer το δικαίωμα της \"Προσβασιμότητας\"."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στην επιφάνεια εργασίας σας, πρέπει να παραχωρήσετε στο Desk Viewer το δικαίωμα της \"Εγγραφή οθόνης\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο Desk Viewer να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλούμε να μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος Desk Viewer]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep Desk Viewer background service", "Διατήρηση της υπηρεσίας παρασκηνίου του Desk Viewer"),
        ...
        ("Show Desk Viewer", "Εμφάνιση του Desk Viewer"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με το πληκτρολόγιο, πρέπει να παραχωρήσετε στο Desk Viewer το δικαίωμα της \"Παρακολούθηση εισόδου\"."),
        ("config_microphone", "Για να μιλήσετε εξ αποστάσεως, πρέπει να παραχωρήσετε στο Desk Viewer το δικαίωμα της \"Εγγραφή ήχου\"."),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο πλήκτρο Εντάξει στο παράθυρο UAC όπου εκτελείται το Desk Viewer."),
        ...
        ("verify_deskviewer_password_tip", "Επιβεβαιώστε τον κωδικό του Desk Viewer"),
        ...
        ("{} sessions", "{} συνεδρίες"),
        ("safety_title", "Ίσως είστε θύμα ΑΠΑΤΗΣ!"),
        ("safety_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το Desk Viewer, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ("safety_text2", "Πιθανόν είναι κάποιος απατεώνας ο οποίος προσπαθεί να αποσπάσει τα στοιχεία του τραπεζικού σας λογαριασμού, τα χρήματά σας και τις προσωπικές σας πληροφορίες."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το Desk Viewer Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Το SELinux είναι ενεργοποιημένο στη συσκευή σας, κάτι που ενδέχεται να εμποδίσει την σωστή λειτουργία του Desk Viewer ως ελεγχόμενης πλευράς."),
        ...
        ("powered_by_me", "Με την υποστήριξη του Desk Viewer"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο Desk Viewer είναι ανοιχτό"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου Desk Viewer"),
        ("Keep screen on", "Διατήρηση οθόνης Ανοιχτή"),
        ("Never", "Ποτέ"),
        ("During controlled", "Κατα την διάρκεια απομακρυσμένου ελέγχου"),
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας Desk Viewer"),
        ...
        ("About Desk Viewer", "Πληροφορίες για το Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "Αναβαθμίστε τον πελάτη Desk Viewer στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Από προεπιλογή, το Desk Viewer επαληθεύει το πιστοποιητικό διακομιστή για πρωτόκολλα που χρησιμοποιούν TLS.\nΜε ενεργοποιημένη αυτήν την επιλογή, το Desk Viewer θα παρακάμψει το βήμα επαλήθευσης και θα προχωρήσει σε περίπτωση αποτυχίας επαλήθευσης."),
        ("Disable UDP", "Απενεργοποίηση UDP"),
        ("disable-udp-tip", "Ελέγχει εάν θα χρησιμοποιείται μόνο TCP.\nΌταν είναι ενεργοποιημένη αυτή η επιλογή, το Desk Viewer δεν θα χρησιμοποιεί πλέον το UDP 21116, αλλά θα χρησιμοποιείται το TCP 21116."),
        ("server-oss-not-support-tip", "ΣΗΜΕΙΩΣΗ: Το OSS του διακομιστή Desk Viewer δεν περιλαμβάνει αυτήν τη λειτουργία."),

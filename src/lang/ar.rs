...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة Desk Viewer..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. Desk Viewer قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت Desk Viewer في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح Desk Viewer اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح Desk Viewer اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ Desk Viewer باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [Desk Viewer Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep Desk Viewer background service", "ابق خدمة Desk Viewer تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق Desk Viewer, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show Desk Viewer", "عرض Desk Viewer"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من Desk Viewer اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح Desk Viewer اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في Desk Viewer الذي يعمل."),
        ...
        ("verify_deskviewer_password_tip", "تحقق من كلمة مرور Desk Viewer"),
        ...
        ("{} sessions", "{} جلسات"),
        ("safety_title", "عنوان الاحتيال"),
        ("safety_text1", "تحذير! هذا قد يكون هجوم احتيالي."),
        ("safety_text2", "يرجى توخي الحذر وعدم الموافقة على الاتصال إذا كنت غير متأكد."),
        ...
        ("upgrade_deskviewer_server_pro_to_{}_tip", "ترقية خادم Desk Viewer Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع Desk Viewer"),
        ...
        ("About Desk Viewer", "حول Desk Viewer"),
        ...
        ("upgrade_remote_deskviewer_client_to_{}_tip", "ترقية عميل Desk Viewer البعيد إلى {}"),
